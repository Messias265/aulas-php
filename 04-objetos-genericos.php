...
<?php 
// Criando um objeto/instâncias a partir da classe stdClass (Standard Class)
...
$usuario->idade = 70;
$usuario->telefones = ["11-98765-4321", "11-2135-0300"]; // Array indexado
...
<ul>
    ...
    <li>
        Peso: <?= $usuario->caracteristicas->peso ?>
    </li>
</ul>
    ...
    <h2>Convertendo array e objeto</h2>
    <?php 
    $curso = [
        "titulo" => "PHP Básico",
        "carga_horaria" => 40,
