...
<body>
    ...
    ?>
    <p><b>Média:</b> <?= $media ?></p>
    <p><b>Faltas: <?= $faltas ?></b></p>

    <!-- O aluno só estará aprovado se tiver médoa de pelo menos 7 e faltas de no máximo 10 -->
    <?php
    ...
    <!-- || duplo PIPE -->
    <h2>|| (OU/OR)</h2>
    <p>Retorna <b>verdadeiro/true</b> se pelo menos <b>uma</b> das condições for verdadeira. </p>
    <?php
    ...
    $temCupom = false; // valor/tipo lógico ()
    ...
    ?>
        ...
        <p>Valor: <?= $valor - $valor * $percentualDesconto ?></p>
    <?php
    else:
    ?>
    ...
    <p>Inverte a lógica, ou seja, <b>verdadeiro/true</b> verdadeira <b>falso/false</b></p>
<?php 
/* Se o usuário NÃO ESTIVER logado, mostre o link de login.
Caso contrário, exibir uma saudação. */
$usuarioLogado = false;

if(!$usuarioLogado): // sem ! , usuario esta logado // se tiver ! usuario n esta logado
?>
