...
<body>
    ...
    $curso = array("Excel", "JavaScript", "Games 2D", "PHP");
    ...
    ?>
        ...
        <ul>
            ...
            <li>Gostaria de estudar mais sobre o <?= $curso[0] ?></li>
    ...
    <p>CH: <b><?= $curso["carga-horaria"] ?></b></p>
    <p>Descrição: <b><?= $curso["descricao"] ?></b></p>
    <p>Prestadora de servições: <i><?= EMPRESA["nome"] ?></i></p>
    ...
    <h3>Acessando dados da matrix de arrays indexados</h3>
    <p>Meu foco agora é no <?= $planoDeEstudos[1][0] ?></p>
    <p>O <?=  $clientes[0]["nome"] ?> me deve <?= $clientes[0]
    ["me_devendo"]  ?></p>

    <h2>Funções de análise/debug de estruturas de dados (arrays, objetos)</h2>

    <?php 
   // echo $bandas; // não funciiona, pois o echo não consegue exibir arrays 
