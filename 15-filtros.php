...
<body>
    ...
    <hr>
    <p>Filtros são recursos de análise e limpeza de dados aplicados através de funções especiais, normalmente as funções especiais, normalmente as funções <code>filter_var()</code> e <code>filter_input</code> e também com o uso de <b>constantes</b> de validação/sanitização.</p>
