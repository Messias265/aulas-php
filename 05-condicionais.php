...
-->
    ...
    <h2>Condicional COMPOSTA: <code>if/ese</code></h2>
    ...
    if ($qtdEmEstoque === 0) {
     ...
     // if/ese Versão abreviada (shorthand if) ?:
    ...
    <h3>Usando os comandos <code>switchcase/default/break</code></h3>

    <?php 
    /* Protótipo de chatbot
    Opções: 1 (informações), 2 (reclamação), 3 (elogio), X (inválida)
    */
    $opcao = 4; // entrada simulada
    switch ($opcao) {
        case 1: echo "<p>Legal, o que quer saber?</p>"; break;
        case 2: echo  "<p>Que pena, o que houver?</p>";break;
