...
<body>
    ...
    <div>
        ...
        ?>
        <p>Saudação 1: <?= exibirMensagem("Bom tarde", "Samuel") ?></p>
        <p>Saudação 2: <?= exibirMensagem("bom dia") ?></p>
        <hr>

        <h2> Função com indução de tipos de dados</h2>
        <p>Nesta abordagem, definimos tipos dfe dados para os parâmetros e para o retorno da função.</p>
        ...
        <p>Numero -10: <?=  verificarNegativo(-10) ?></p>
        <p>Teste para erro: <?= verificarNegativo("") ?></p>
