...
?>
    ...
    <p>Variavél <code>$nome</code> original: <?= $nome ?></p>
...
<?php 
$categorias = ["Eletrônicos", "Livros", "Roupas", "Livros", "Games", "Eletrônicos"];
...
$servicosConcluidos = array_filter(
    $servicos, fn( array $servico) => $servico["status"] === "Concluído"
);
?>
